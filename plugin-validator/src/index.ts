...
import type { VxeTableDefines, VxeFormDefines, VxeGlobalValidatorsHandles } from 'vxe-table'
import type { VxeUIPluginValidatorOptions, VxeUIPluginValidatorOptionCustomRegExp } from '../types'

let VxeUI: VxeUIExport

const reMobile = /^0?(13[0-9]|15[012356789]|17[013678]|18[0-9]|19[0-3,5-9]|14[57])[0-9]{8}$/
...
const customRegExpMaps: VxeUIPluginValidatorOptionCustomRegExp = {}
 ...
 * @param options 参数
 */
function pluginConfig (options: VxeUIPluginValidatorOptions) {
  if (options) {
...
export const VxeUIPluginValidator = {
  ...
  install (core: VxeUIExport, options?: VxeUIPluginValidatorOptions) {
    VxeUI = core
